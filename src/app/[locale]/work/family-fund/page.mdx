...
We installed 24 Mac Minis bought from craigslist in their storage facility. One machine would be used for the web server and another one for the build server. The other 22 were for redundancy, and to DDOS squarespace.com every few months to keep them on their toes.
